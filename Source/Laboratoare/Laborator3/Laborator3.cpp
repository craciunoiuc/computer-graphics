...
void Laborator3::Update(float deltaTimeSeconds)
{
	...
	//TODO create animations by multiplying current transform matrix with matrices from Transform 2D
	modelMatrix *= Transform2D::Scale(0.002 * translateX, 0.001 * translateY);
	Tu += deltaTimeSeconds * 10;
	modelMatrix *= Transform2D::Rotate(Tu);
	...
	//TODO create animations by multiplying current transform matrix with matrices from Transform 2D
	modelMatrix *= Transform2D::Scale(2, 1);
	modelMatrix *= Transform2D::Rotate(50);
